...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2023 at 01:50 PM
...
INSERT INTO `order_master` (`order_id`, `customer_id`, `first_name`, `last_name`, `phone`, `email`, `total_product`, `total`, `shipping_address`, `status`) VALUES
(1, 1, 'croma', 'relience mall', 1234567890, 'croma@gmail.com', 2, 160000, '150ft ring road,westzone ,rajkot.', 0),
(2, 1, 'crystal', 'mall', 456464650, 'crystal@gmail.com', 4, 23400, 'kalavad road,rajkot.', 0),
(4, 9, 'shiv', 'shiv', 123456312, 'shiv@gmail.com', 2, 73000, 'rajkot', 0);
...
(1, 1, 1, 30, 'samsung', 2, 80000),
(2, 2, 1, 32, 'series', 1, 2700),
(3, 2, 1, 33, 'cannon', 2, 10000),
(4, 2, 1, 34, 'bag', 1, 700),
(8, 4, 9, 38, 'new brand', 1, 48000),
(9, 4, 9, 40, 'lenovo', 1, 25000);
...
--
ALTER TABLE `order_products`
  MODIFY `ordprod_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
