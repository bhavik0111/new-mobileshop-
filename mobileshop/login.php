...
if(isset($_POST['submit']))
{
    ...
    $usr_query = "SELECT * FROM `user_master` WHERE `usr_name`='".$usr_name."' AND `usr_password`='".md5($usr_password)."' ";
    $usr_result = mysqli_query($conn, $usr_query); 
        ...
        if(mysqli_num_rows($usr_result) === 1)
        {
           ...
           header("location:".SITE_URL."/login.php?msg");
        }
}
?>
<tr><td align="center"><h3><b>User login</b></h3></td></tr>
<tr><td align="center"><?php if(isset($_GET["msg"])){ echo "Please Enter Valid email and password!"; } ?></td></tr>
<tr><td>
